...
const SignUp = () => {
    ...
    return (
        <div className="flex sm:mt-24 md:mt-5 justify-center items-center h-[85vh]px-2">
            <div className="relative flex flex-col rounded-xl bg-transparent bg-clip-border text-gray-700 shadow-none">
                ...
                <form onSubmit={handleSignUp} className="mt-8 mb-2">
                    ...
                    <button onClick={handleGoogleSignUp} className="mt-6 flex justify-center gap-3 items-center w-full select-none rounded-lg bg-orange-100 py-3 px-6 text-center align-middle font-sans text-xs font-bold  shadow-md shadow-pink-500/20 transition-all hover:shadow-lg hover:shadow-pink-500/40 focus:opacity-[0.85] focus:shadow-none active:opacity-[0.85] active:shadow-none disabled:pointer-events-none disabled:opacity-50 disabled:shadow-none text-blue-600"
